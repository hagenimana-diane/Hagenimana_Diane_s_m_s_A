...
public class List_of_customers extends JFrame {
...
public List_of_customers() {
	...
	String[] column= {"CustomerID","FirstName","LastName","Email"};
...
public List_of_customers(DefaultTableModel defaultTableModel) {
